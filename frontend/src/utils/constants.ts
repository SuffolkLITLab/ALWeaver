...
const KNOWN_LABELS: Partial<Record<BlockType, string>> = {
  metadata: 'Metadata',
  objects: 'Objects',
  code: 'Code',
  ...
  include: 'Include',
  'default screen parts': 'Default Screen Parts',
  modules: 'Modules',
  imports: 'Imports',
  sections: 'Sections',
  'interview help': 'Interview Help',
  def: 'Definition',
  'default validation messages': 'Default Validation Messages',
  'machine learning storage': 'Machine Learning Storage',
  initial: 'Initial',
  comment: 'Comment',
  'variable name': 'Variable Name',
  data: 'Data',
  'data from code': 'Data From Code',
  reset: 'Reset',
  'on change': 'On Change',
